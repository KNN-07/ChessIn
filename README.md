...
- **Analyze without an account.** A dark, board-first Game Review workspace pairs a green board with player rows, a white feedback bubble, color-coded figurine notation, on-board quality badges and a selectable evaluation timeline. First/previous/play-pause/next/last controls navigate the game, with Moves, Engine and Review tabs preserving the full analysis workflow. Player ratings and recorded PGN clocks appear when present; missing scores and clocks are never fabricated. Import PGN variations/comments, paste FEN and export your annotated game; your library stays in your browser.
